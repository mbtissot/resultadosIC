...
WRITE(3,*) '    it', '    tau','            EL','           ES','          ET','            ETF','            ETH','            ET3'
OPEN(4,FILE='energies.wt')
WRITE(4,*) '    it', '    Epart', '         Ewave', '         Etot', '          Ep/Et', '         Ew/Et'
OPEN(1,FILE='Ini.wt')
READ(1,*) Iflag
READ(1,*) nux,nuz
READ(1,*) nqx,nqz
...
SELECT CASE(TimeEvol)
 ...
 CASE("Yes")
  ...
  DO it= 1,Nitera
   ...
   WRITE(2,2001) it,Tau,Rn,Rp,Rw,Rs
   CALL Energy2(EwaveL,EWaveS,EwaveT,EwaveTF,EwaveTH,EwaveT3)
   WRITE(4,2001) it,Tau,Epart,Ewave,EppEw,Epart/EppEw,Ewave/EppEw ! Writing to energies.wt
   WRITE(3,2001) it,Tau,EwaveL,EwaveS,EwaveT,EwaveTF,EwaveTH,EwaveT3
