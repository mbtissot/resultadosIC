...
!CALL Derivx5p2d(nux,nuz,VUx,VUz,CDxx,DDxxdux) ! 1
CALL Derivx5p2d(nux,nuz,VUx,VUz,CDxz,DDxzdux) ! 2
CALL Derivy5p2d(nux,nuz,VUx,VUz,CDzx,DDzxduz) ! 3
CALL Derivy5p2d(nux,nuz,VUx,VUz,CDzz,DDzzduz) ! 4
CALL Derivx5p2d(nux,nuz,VUx,VUz,CAx,DAxdux)   ! 5
CALL Derivy5p2d(nux,nuz,VUx,VUz,CAz,DAzduz)   ! 6
...
SELECT CASE(DerivLn)
 CASE("Yes")
  ...
  Dfdux(1,:)= 0.
 CASE("No ")
  CALL Derivxy5p2d(nux,nuz,VUx,VUz,Fe,Dfdux,Dfduz) ! 7
  Dfdux(1,:)= 0.
END SELECT
CALL Derivxy5p2d(nux,nuz,VUx,VUz,Dfdux,Dfduxdux,Dfduxduz) ! 8
CALL Derivxy5p2d(nux,nuz,VUx,VUz,Dfduz,Dfduzdux,Dfduzduz) ! 9
Dfduxdux(1,:)= 0.
Dfduxduz(1,:)= 0.
Dfduzdux(1,:)= 0.
...
DO j=1,ny,1
  ...
  DO i=3,nxm2,1
   ...
   IF (Vx(i)>-5. .and. Vx(i)<5. .and. Vy(j)>4. .and. Vy(j)<8) THEN
    WRITE (*,*) 'Dfdx(i,j):', Dfdx(i,j), 'i: ', i, 'j: ', j
   END IF
  END DO
END DO
...
DO i=1,nx,1
 ...
 DO j=3,nym2,1
  ...
  IF (Vx(i)>-5. .and. Vx(i)<5. .and. Vy(j)>4. .and. Vy(j)<8) THEN
    WRITE (*,*) 'Dfdy(i,j):', Dfdy(i,j), 'i: ', i, 'j: ', j
  END IF
 END DO
END DO
...
SUBROUTINE Derivx5p2d(nx,ny,Vx,Vy,Fxy,Dfdx)
! Version Jan. 2010: 
...
!
SUBROUTINE Derivy5p2d(nx,ny,Vx,Vy,Fxy,Dfdy)
! Version Jan. 2010: 
